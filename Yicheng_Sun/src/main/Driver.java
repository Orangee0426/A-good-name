...
public class Driver {
     ...
     *
     *
     *      *developerName: 开发人员名字
     *  * developerWebsite： 开发文员网站
     */
    private void addApp(){
        String s = ScannerInput.validNextLine("请输入开发者姓名：");
        String s1 = ScannerInput.validNextLine("请输入开发者网站：");
        Developer developer = new Developer(s,s1);
        String s2 = ScannerInput.validNextLine("请输入appName：");
        double d1 = ScannerInput.validNextDouble("请输入appSize：");
        double d2 = ScannerInput.validNextDouble("请输入appVersion：");
        double d3 = ScannerInput.validNextDouble("请输入appCost：");
    ...
    private void updateApp(){
        int i = ScannerInput.validNextInt("请输入要修改的index：");
        ...
        System.out.println("共享您，修改成功");
    }

    private void deleteApp(){
        int i = ScannerInput.validNextInt("请输入要删除的index：");
